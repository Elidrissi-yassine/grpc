...
public final class MultiplicationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<g71.stub.TpStream.MultiplicationRequest,
      g71.stub.TpStream.MultiplicationResponse> getGetMultiplicationTableMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMultiplicationTable",
      requestType = g71.stub.TpStream.MultiplicationRequest.class,
      responseType = g71.stub.TpStream.MultiplicationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<g71.stub.TpStream.MultiplicationRequest,
      g71.stub.TpStream.MultiplicationResponse> getGetMultiplicationTableMethod() {
    io.grpc.MethodDescriptor<g71.stub.TpStream.MultiplicationRequest, g71.stub.TpStream.MultiplicationResponse> getGetMultiplicationTableMethod;
      ...
      synchronized (MultiplicationGrpc.class) {
        if ((getGetMultiplicationTableMethod = MultiplicationGrpc.getGetMultiplicationTableMethod) == null) {
          MultiplicationGrpc.getGetMultiplicationTableMethod = getGetMultiplicationTableMethod = 
              io.grpc.MethodDescriptor.<g71.stub.TpStream.MultiplicationRequest, g71.stub.TpStream.MultiplicationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Multiplication", "GetMultiplicationTable"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  g71.stub.TpStream.MultiplicationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  g71.stub.TpStream.MultiplicationResponse.getDefaultInstance()))
  ...
  public static abstract class MultiplicationImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getMultiplicationTable(g71.stub.TpStream.MultiplicationRequest request,
        io.grpc.stub.StreamObserver<g71.stub.TpStream.MultiplicationResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                g71.stub.TpStream.MultiplicationRequest,
                g71.stub.TpStream.MultiplicationResponse>(
  ...
  public static final class MultiplicationBlockingStub extends io.grpc.stub.AbstractStub<MultiplicationBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<g71.stub.TpStream.MultiplicationResponse> getMultiplicationTable(
        g71.stub.TpStream.MultiplicationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MULTIPLICATION_TABLE:
          serviceImpl.getMultiplicationTable((g71.stub.TpStream.MultiplicationRequest) request,
              (io.grpc.stub.StreamObserver<g71.stub.TpStream.MultiplicationResponse>) responseObserver);
          break;
        default:
